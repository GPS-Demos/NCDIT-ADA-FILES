...
**Pipeline Status**: FAIL: 2/3 chunks failed (below 50% threshold): chunk 1 (pages 1-2): API call budget exhausted for source.pdf [pages 1-2]; chunk 2 (pages 2-3): API call budget exhausted for source.pdf [pages 2-3]
**Processing Time**: 14.7s
**Confidence**: N/A
