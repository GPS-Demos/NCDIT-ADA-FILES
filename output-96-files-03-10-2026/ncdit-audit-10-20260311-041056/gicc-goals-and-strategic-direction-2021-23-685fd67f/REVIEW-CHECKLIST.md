...
**Processing Time**: 684.7s
**Confidence**: 97%
**Edge Case Flags**: complex_tables, image_resolution_issue
...
- Log: `2026-03-10 23:58:41,976 src.services.processing.pipeline: Image resolution: 17 placeholders, 0 transparent, 21 extracted, Pass 1 exact=17, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-10 23:58:41,974 src.services.conversion: Post-merge dedup: removed 0 duplicate section(s), 10 repeated image(s)`
...
- Log: `2026-03-10 23:58:41,972 src.services.conversion: Merged 2 chunks: 3 sections total`
