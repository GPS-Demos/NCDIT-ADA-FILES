...
**Batch**: `ncdit-audit-10-20260311-015343`
**Pipeline Status**: PASS
**Processing Time**: 172.7s
**Confidence**: 93%
...
- Log: `2026-03-10 20:55:26,345 src.services.processing.pipeline: Image resolution: 5 placeholders, 6 extracted, Pass 1 exact=5, Pass 1 hash=0, Pass 2 positional=0, unresolved=0`
...
- Log: `2026-03-10 20:55:26,341 src.services.merge_verification: Merge dedup: removed 2 elements at indices [0, 1]`
...
- Log: `2026-03-10 20:55:26,343 src.services.conversion: Merged 2 chunks: 8 sections total`
