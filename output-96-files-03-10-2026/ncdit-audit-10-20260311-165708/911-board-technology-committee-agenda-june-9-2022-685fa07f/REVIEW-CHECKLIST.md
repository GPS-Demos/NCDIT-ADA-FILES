...
- Log: `2026-03-11 12:13:33,769 src.services.processing.pipeline: Image resolution: 4 placeholders, 0 transparent, 13 extracted, Pass 1 exact=4, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-11 12:13:33,766 src.services.conversion: Post-merge dedup: removed 0 duplicate section(s), 3 repeated image(s)`
...
- Log: `2026-03-11 12:13:33,766 src.services.conversion: Merged 2 chunks: 10 sections total`
...
## Audit Results
Score=83, Grade=Fair, Routing=human_review
