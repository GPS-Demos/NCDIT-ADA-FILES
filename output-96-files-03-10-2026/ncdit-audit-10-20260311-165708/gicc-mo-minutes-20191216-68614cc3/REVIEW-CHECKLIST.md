...
- Log: `2026-03-11 12:26:49,987 src.services.processing.pipeline: Image resolution: 0 placeholders, 0 transparent, 0 extracted, Pass 1 exact=0, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-11 12:26:49,990 src.services.processing.pipeline: Removed 16 heading(s) that duplicated their section title`
...
## Audit Results
Score=98, Grade=Good, Routing=auto_approve
