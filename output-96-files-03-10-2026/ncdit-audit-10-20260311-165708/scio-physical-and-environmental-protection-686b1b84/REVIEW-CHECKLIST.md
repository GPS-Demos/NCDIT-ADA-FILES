...
- Log: `2026-03-11 12:40:16,579 src.services.processing.pipeline: Image resolution: 3 placeholders, 0 transparent, 12 extracted, Pass 1 exact=3, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-11 12:40:16,577 src.services.conversion: Post-merge dedup: removed 0 duplicate section(s), 3 repeated image(s)`

### Fix 4: Table Extraction Accuracy
- [ ] Tables have `<th>` header cells
- [ ] Table count matches baseline
- Log: `2026-03-11 12:40:16,579 src.services.processing.pipeline: Table extraction mismatch for source.pdf: baseline=2 tables, gemini=0 tables (< 50%)`

### Fix 5: Link Fragmentation
- [ ] No adjacent `<a>` tags with same href
- Log: `2026-03-11 12:40:16,577 src.services.conversion: Merged 2 chunks: 23 sections total`
