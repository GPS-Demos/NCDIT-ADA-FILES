...
**Batch**: `ncdit-audit-10-20260311-175258`
**Pipeline Status**: PASS
**Processing Time**: 557.5s
**Confidence**: 98%
...
- Log: `2026-03-11 13:00:08,680 src.services.processing.pipeline: Image resolution: 5 placeholders, 0 transparent, 5 extracted, Pass 1 exact=5, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-11 13:00:08,685 src.services.processing.pipeline: Removed 17 heading(s) that duplicated their section title`
...
- Log: `2026-03-11 13:00:08,676 src.services.conversion: Merged 2 chunks: 14 sections total`
...
## Audit Results
Score=81, Grade=Fair, Routing=human_review
