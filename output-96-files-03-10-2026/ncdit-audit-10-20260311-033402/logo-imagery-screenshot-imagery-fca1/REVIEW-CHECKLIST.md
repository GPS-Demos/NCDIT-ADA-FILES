...
**Batch**: `ncdit-audit-10-20260311-033402`
**Pipeline Status**: PASS
**Processing Time**: 369.0s
**Confidence**: 98%
...
- Log: `2026-03-10 22:38:36,555 src.services.processing.pipeline: Image resolution: 23 placeholders, 0 transparent, 25 extracted, Pass 1 exact=23, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-10 22:38:36,553 src.services.conversion: Post-merge dedup: removed 0 duplicate section(s), 4 repeated image(s)`
...
- Log: `2026-03-10 22:38:36,553 src.services.conversion: Merged 2 chunks: 10 sections total`
...
## Audit Results
Score=75, Grade=Fair, Routing=human_review
