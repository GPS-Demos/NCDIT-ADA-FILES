...
- Log: `2026-03-10 21:33:55,244 src.services.processing.pipeline: Image resolution: 4 placeholders, 0 transparent, 6 extracted, Pass 1 exact=4, Pass 1 hash=0, Pass 2 positional=0, Pass 3 chunk-reresolved=0, unresolved=0`
...
- Log: `2026-03-10 21:33:55,242 src.services.conversion: Post-merge dedup: removed 0 duplicate section(s), 2 repeated image(s)`
...
- Log: `2026-03-10 21:33:55,242 src.services.conversion: Merged 2 chunks: 8 sections total`
...
## Audit Results
Score=74, Grade=Fair, Routing=human_review
